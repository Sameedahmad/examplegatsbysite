...
import { GoogleMap } from "@react-google-maps/api" // plasmic-import: Jf5Ynw79vT9eH/codeComponent
...
import * as sty from "./PlasmicColumns.module.css" // plasmic-import: zUrHpZIPmePfPJ/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          ...
          >
            <YouTube
              className={classNames("__wab_instance", sty.youTube__mCsin)}
              videoId={"R6MeLqRQzYw"}
            />
          </ListItem>
        ),
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <ListItem
            ...
            className={classNames("__wab_instance", sty.listItem__dXdKm)}
            title={"Google Maps"}
          >
            <GoogleMap
              center={{ lat: -5, lng: -40 }}
