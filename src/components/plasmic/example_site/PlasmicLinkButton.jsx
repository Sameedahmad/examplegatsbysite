...
import * as sty from "./PlasmicLinkButton.module.css" // plasmic-import: f8pNAcrPRjP-Wu/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__ugJuK)}
                role={"img"}
              />
            ),
