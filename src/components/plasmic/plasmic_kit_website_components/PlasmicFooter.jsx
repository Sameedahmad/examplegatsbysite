                  ...
                  <div className={classNames(defaultcss.all, sty.box___8KRCf)}>
                    ...
                    <Linky
                      className={classNames(
                        ...
                        sty.linky__hwJsx,
                        {
                          [sty.linky__global_theme_dark__hwJsxh5AZc]: hasVariant(
                            globalVariants,
                            "theme",
                            "dark"
                          ),
                    ...
                    {false ? (
                      <Linky
                        className={classNames(
                          ...
                          sty.linky__kdvYo,
                          {
                            [sty.linky__global_theme_dark__kdvYoH5AZc]: hasVariant(
                              globalVariants,
                              "theme",
                              "dark"
                            ),
                ...
                >
                  <div
                    className={classNames(
                      ...
                      sty.box__gbj13,
                      {
                        [sty.box__global_theme_altHeadlineFont__gbj13FQkvX]: hasVariant(
                          globalVariants,
                          "theme",
                          "altHeadlineFont"
                        ),
